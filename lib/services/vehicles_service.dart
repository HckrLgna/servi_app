...
class VehicleService extends ChangeNotifier{
  ...
  Future<String?> uploadImage()async{
    ...
    imageUploadRequest.files.add(http.MultipartFile.fromBytes('file', File(newPictureFile!.path).readAsBytesSync(), filename: newPictureFile!.path.split('/').last));
